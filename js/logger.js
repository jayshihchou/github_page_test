...
var LogType = Object.freeze({ "Log": 0, "Warning": 1, "Error": 2 });
...
class Logger {
    constructor() {
        ...
        console.log = function (message) {
            if (logger.showStack) {
                try { throw new Error(); }
                catch (e) { message += e.stack; }
            }

            logger.setLog(LogType.Log, message);
        ...
        console.warn = function (message) {
            ...
            logger.setLog(LogType.Warning, message);
        ...
        console.error = function (message) {
            ...
            logger.setLog(LogType.Error, message);
    ...
    drawLogs() {
        ...
        var c, max;
        for (c = 0, max = this.logs.length; c < max; ++c) {
            var message = this.logs[c].message;
            var logType = this.logs[c].logType;
            switch (logType) {
                case LogType.Log:
